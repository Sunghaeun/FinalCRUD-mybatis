...
<div class=" jumbotron p-4 p-md-5 text-white rounded " style="background-color: #a50000;">
  <div class="col-md-6 px-0">
  <h1 class="display-4 font-italic">Christmas Song🎄 Recommendations⭐</h1>
  <p class="lead my-3">We will help you find the song you want with information on various carols, including singers and genres!</p>
